...
import 'skor_peserta_mhs_model.dart';
export 'skor_peserta_mhs_model.dart';

class SkorPesertaMhsWidget extends StatefulWidget {
  const SkorPesertaMhsWidget({
    super.key,
  ...
  @override
  State<SkorPesertaMhsWidget> createState() => _SkorPesertaMhsWidgetState();
}

class _SkorPesertaMhsWidgetState extends State<SkorPesertaMhsWidget> {
  late SkorPesertaMhsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SkorPesertaMhsModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuizzesRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final skorPesertaMhsQuizzesRecord = snapshot.data!;
                    ...
                    return SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                                      ...
                                      child: Container(
                                        ...
                                        child: TextFormField(
                                          controller: _model.textController ??=
                                            ...
                                            text: skorPesertaMhsQuizzesRecord
                                                .name,
                                          ),
                          ...
                          if (((skorPesertaMhsQuizzesRecord
                                      .responsOcr.isNotEmpty) ==
                                  false) &&
                              ((skorPesertaMhsQuizzesRecord
                                      .respons.isNotEmpty) ==
                                  false))
                            Align(
                                ...
                                child: StreamBuilder<List<ResponsesOcrRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    List<ResponsesOcrRecord>
                                        ...
                                        snapshot.data!;
                                    final textResponsesOcrRecord =
                                        textResponsesOcrRecordList.isNotEmpty
                                            ? textResponsesOcrRecordList.first
                                            : null;
